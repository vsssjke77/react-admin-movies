...
function MovieDetails({ movie, UpdateMovie, onMovieUpdate }) {
    ...
    const handleEditFormClose = () => {
        setIsEditing(false); // Устанавливаем isEditing в false, чтобы закрыть форму
    };
    ...
    const handleCopyId = () => {
        // Копирование Id фильма в буфер обмена
        const idToCopy = movie.id;

        // Создаем временный textarea, копируем в него Id, выбираем его и копируем в буфер обмена
...
/*        alert(`Id ${idToCopy} скопирован в буфер обмена`);
*/    };
    return (
        <div className="selected-movie">
            <div className="header-movie">
                <div className="header-leftside">
                    ...
                    <button onClick={handleCopyId}>
                        <img src="iconcopy.png" alt="Copy ID"></img>
                    </button>
                </div>
            ...
            {/* Отображение формы редактирования при isEditing === true */}
            {isEditing && <EditForm movie={movie} onClose={handleEditFormClose} UpdateMovie={UpdateMovie} onMovieUpdate={onMovieUpdate} />}
            <div className="info">
